function f = show_info(msg,wtitle)
...
% of the dialog. However, if you do that you must assign a handle to show_info so you
...
% show_info(msg)
% h = show_info(msg)
% show_info(msg,wtitle)
% h = show_info(msg,wtitle)
%
% show_info and h = show_info without any input arguments create an example.
% 
% show_info(msg) and h = show_info(msg) display the user-defined message msg
% which should be a character string or a cell array of strings.
%
% show_info(msg,wtitle) and h = show_info(msg,wtitle) display the user-defined 
...
% Examples
%
% h1 = show_info('Running - Please wait...');
% 
% h2 = show_info({'This is a long message for a long process.',...
